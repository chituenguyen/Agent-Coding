  ...
  return (
    <div className="flex gap-2">
      ...
      >
        {/* Folder icon */}
        <svg
          className={`w-4 h-4 shrink-0 ${hasValue ? "text-indigo-500 dark:text-indigo-400" : "text-gray-400 dark:text-gray-500"}`}
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
        ...
        {hasValue ? (
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-indigo-700 dark:text-indigo-300 truncate leading-tight">
              {folderName}
            </p>
            <p className="text-xs text-indigo-400 dark:text-indigo-500 font-mono truncate leading-tight">
              {value.trim()}
            </p>
          </div>
        ) : (
